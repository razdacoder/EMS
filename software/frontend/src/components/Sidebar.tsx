      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div className="flex gap-x-2 items-center">
            ...
            {/* <h5 className="font-bold font-sans leading-none text-black">
              The Federal Polythecnic, Ilaro
            </h5> */}
          </div>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/app/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black  duration-300 ease-in-out hover:bg-success / 20 dark:hover:bg-meta-4 hover:text-bodydark1 ${
                    pathname.includes("dashboard") &&
                    "bg-success dark:bg-meta-4 text-bodydark1"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/app/departments"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-success dark:hover:bg-meta-4 hover:text-bodydark1 ${
